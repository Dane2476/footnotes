...
def index():
    if request.method == "GET":
        ...
        if userInfo == None or not check_password_hash(userInfo[2], password):
...
def api(isbn):
    ...
    # Store data from books table in variables
    title = book_info[0][2]
